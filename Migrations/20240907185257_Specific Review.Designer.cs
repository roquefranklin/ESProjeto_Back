...
namespace ESProjeto_Back.Migrations
{
    ...
    [Migration("20240907185257_Specific Review")]
    partial class SpecificReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESProjeto_Back.Models.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ESProjeto_Back.Models.SpecificReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("SpecificReviewScore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ESProjeto_Back.Models.Review", b =>
                {
                    b.HasOne("ESProjeto_Back.Models.StopPoint", "StopPoint")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("ESProjeto_Back.Models.SpecificReview", b =>
                {
                    b.HasOne("ESProjeto_Back.Models.Review", "Review")
                        .WithMany("SpecificReviews")
